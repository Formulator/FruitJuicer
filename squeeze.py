...
#Instantiate PyFruitJuicer, C++ FruitJuicer constructor will initiate a thread executing print_list once as a callback. 	
jcr = PyFruitJuicer(print_list, [b"pear", b"peach", b"mango"])#'b' to mark as bytes literals to permit passing to C++
